#from ..indexing.service.indexing import index_products
#from .search_service import search_products
#from ..indexing.service.upload_service import process_and_index_csv
#from ..infra.weaviate_client import create_weaviate_client
#from .autocomplete_service import get_autocomplete_suggestions
#from ..infra.embedding_client import encode_text
